...
//
//@Autonomous
//public class AutoBlueComuna133_138 extends LinearOpMode {
//
//    //drivetrain
...
//                .build();
//
//        Trajectory park = drive.trajectoryBuilder(new Pose2d(64,33,Math.toRadians(90)))
...
//                .strafeTo(new Vector2d(88,10))
//                .build();
//
//        Trajectory goBack = drive.trajectoryBuilder(new Pose2d(88,10))
//                .strafeTo(new Vector2d(60,0))
//                .build();
//
...
//                .lineToLinearHeading(new Pose2d(60,15,Math.toRadians(-8.5)),
...
//
//
//        Trajectory park = drive.trajectoryBuilder(new Pose2d(60,15,Math.toRadians(-8.5)))
...
//
//
//        Trajectory goBack1 = drive.trajectoryBuilder(new Pose2d(117,33))
//                .strafeTo(new Vector2d(60,-2),
//                        new MinVelocityConstraint(
//                                Arrays.asList(
//                                        new AngularVelocityConstraint(DriveConstants.MAX_ANG_VEL),
//                                        new MecanumVelocityConstraint(100 ,DriveConstants.TRACK_WIDTH)
...
//                .build();
//
//        Trajectory goBack2 = drive.trajectoryBuilder(new Pose2d(60,-2))
//                .strafeTo(new Vector2d(23,-2),
//                        new MinVelocityConstraint(
//                                Arrays.asList(
//                                        new AngularVelocityConstraint(DriveConstants.MAX_ANG_VEL),
//                                        new MecanumVelocityConstraint(100 ,DriveConstants.TRACK_WIDTH)
...
//                .build();
//
//        Trajectory prepareForRing = drive.trajectoryBuilder(new Pose2d(23,-2))
...
//
//
//        Trajectory shootRing  = drive.trajectoryBuilder(new Pose2d(23,10))
...
//                .build();
//
//        Trajectory getLastRing = drive.trajectoryBuilder(new Pose2d(36,10))
...
//
//
//        Trajectory park = drive.trajectoryBuilder(new Pose2d(57,10,Math.toRadians(-9)))
