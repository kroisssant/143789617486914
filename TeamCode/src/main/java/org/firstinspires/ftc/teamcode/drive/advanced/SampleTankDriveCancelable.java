 ...
 */
@Config
public class SampleTankDriveCancelable extends TankDrive {
    public static PIDCoefficients AXIAL_PID = new PIDCoefficients(3.1, 0.01, 0);
    public static PIDCoefficients CROSS_TRACK_PID = new PIDCoefficients(0.78, 0.001, 0.6);
    public static PIDCoefficients HEADING_PID = new PIDCoefficients(28, 0.32, 0.14);
    ...
    public SampleTankDriveCancelable(HardwareMap hardwareMap) {
