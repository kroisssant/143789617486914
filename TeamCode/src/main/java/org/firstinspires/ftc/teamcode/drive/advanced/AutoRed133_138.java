...
//
//@Autonomous
//public class AutoRed133_138 extends LinearOpMode {
//
//    //drivetrain
...
//                .build();
//
//        Trajectory getWobble = drive.trajectoryBuilder(new Pose2d(60,-37,0))
//                .strafeTo(new Vector2d(31,-25))
//                .addTemporalMarker(0.39,() ->{
//                    wobble.setPower(-1);
//                })
//                .build();
//
//        Trajectory dropSecondWobble = drive.trajectoryBuilder(new Pose2d(31,-25,0))
...
//                .strafeTo(new Vector2d(30,-23.7))
//                .addTemporalMarker(0.5,() ->{
//                    wobble.setPower(-1);
//                })
//                .build();
//
//        Trajectory prepareForRing = drive.trajectoryBuilder(new Pose2d(30,-23.7))
//                .strafeTo(new Vector2d(17,-5))
//                .build();
//
//
//        Trajectory shootRing  = drive.trajectoryBuilder(new Pose2d(17,-6))
...
//
//
//        Trajectory dropSecondWobble = drive.trajectoryBuilder(new Pose2d(55,-15,0))
...
//
//
//        Trajectory getWobble = drive.trajectoryBuilder(new Pose2d(115,-42))
...
//                .build();
//
//        Trajectory prepareForRing1 = drive.trajectoryBuilder(new Pose2d(30,-21))
...
//                .build();
//
//        Trajectory prepareForRing2 = drive.trajectoryBuilder(new Pose2d(23,-20))
...
//
//
//        Trajectory shootRing  = drive.trajectoryBuilder(new Pose2d(23,-5))
...
//                        ),new ProfileAccelerationConstraint(10 )
//                )
//                .addTemporalMarker(0.03,() ->{
//                    shooter(0.89);
//                })
//                .build();
//
//        Trajectory getLastRing = drive.trajectoryBuilder(new Pose2d(36,-5))
...
//                .build();
//
//        Trajectory dropSecondWobble = drive.trajectoryBuilder(new Pose2d(58,-5,165))
//                .lineToLinearHeading(new Pose2d(111,-37,Math.toRadians(190)),
//                        new MinVelocityConstraint(
//                                Arrays.asList(
//                                        new AngularVelocityConstraint(DriveConstants.MAX_ANG_VEL),
//                                        new MecanumVelocityConstraint(100,DriveConstants.TRACK_WIDTH)
...
//
//
//        Trajectory park = drive.trajectoryBuilder(new Pose2d(111,-37,Math.toRadians(190)))
//                .strafeTo(new Vector2d(85,-30),
//                        new MinVelocityConstraint(
//                                Arrays.asList(
//                                        new AngularVelocityConstraint(DriveConstants.MAX_ANG_VEL),
//                                        new MecanumVelocityConstraint(100 ,DriveConstants.TRACK_WIDTH)
