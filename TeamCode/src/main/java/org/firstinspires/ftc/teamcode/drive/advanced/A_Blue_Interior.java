...
//
//@Autonomous
//public class A_Blue_Interior extends LinearOpMode {
//
//    //drivetrain
...
//
//
//        Trajectory suge1 = drive.trajectoryBuilder(new Pose2d(-8, 0, Math.toRadians(90)))
...
//                .splineTo(new Vector2d(9, 2), Math.toRadians(-3),
//                        new MinVelocityConstraint(
//                                Arrays.asList(
//                                        new AngularVelocityConstraint(DriveConstants.MAX_ANG_VEL),
//                                        new TankVelocityConstraint(80, DriveConstants.TRACK_WIDTH)
...
//                .build();
//
//        Trajectory suge2 = drive.trajectoryBuilder(new Pose2d(-8, 0, Math.toRadians(90)))
//                .splineTo(new Vector2d(-11, 55), Math.toRadians(90),
//                        new MinVelocityConstraint(
//                                Arrays.asList(
//                                        new AngularVelocityConstraint(DriveConstants.MAX_ANG_VEL),
//                                        new TankVelocityConstraint(80, DriveConstants.TRACK_WIDTH)
...
//                .splineTo(new Vector2d(9, 2), Math.toRadians(5),
//                        new MinVelocityConstraint(
//                                Arrays.asList(
//                                        new AngularVelocityConstraint(DriveConstants.MAX_ANG_VEL),
//                                        new TankVelocityConstraint(80, DriveConstants.TRACK_WIDTH)
...
//
//
//        Trajectory back3 = drive.trajectoryBuilder(new Pose2d(9, 2, Math.toRadians(0)))
//                .lineTo(new Vector2d(-8, 0),
//                        new MinVelocityConstraint(
//                                Arrays.asList(
//                                        new AngularVelocityConstraint(DriveConstants.MAX_ANG_VEL),
...
//                .build();
////
////        Trajectory suge3 = drive.trajectoryBuilder(new Pose2d(-8, 0, Math.toRadians(90)))
////                .splineTo(new Vector2d(-11, 120), Math.toRadians(90),
////                        new MinVelocityConstraint(
////                                Arrays.asList(
////                                        new AngularVelocityConstraint(DriveConstants.MAX_ANG_VEL),
////                                        new TankVelocityConstraint(100, DriveConstants.TRACK_WIDTH)
...
////                .build();
//
//        Trajectory park = drive.trajectoryBuilder(new Pose2d(-8, 0, Math.toRadians(90)),true)
...
//        Trajectory merge = drive.trajectoryBuilder(new Pose2d(0, 0, 0))
//                .splineTo(new Vector2d(34, 0), Math.toRadians(-7),
//                        new MinVelocityConstraint(
//                                Arrays.asList(
//                                        new AngularVelocityConstraint(DriveConstants.MAX_ANG_VEL),
//                                        new TankVelocityConstraint(100, DriveConstants.TRACK_WIDTH)
...
//
//
//        Trajectory back = drive.trajectoryBuilder(new Pose2d(34, 0, Math.toRadians(0)))
//                .lineTo(new Vector2d(-8, 0),
//                        new MinVelocityConstraint(
//                                Arrays.asList(
//                                        new AngularVelocityConstraint(DriveConstants.MAX_ANG_VEL),
...
//
//        Trajectory suge1 = drive.trajectoryBuilder(new Pose2d(-8, 0, Math.toRadians(90)))
//                .splineTo(new Vector2d(-11, 100), Math.toRadians(90),
//                        new MinVelocityConstraint(
//                                Arrays.asList(
//                                        new AngularVelocityConstraint(DriveConstants.MAX_ANG_VEL),
//                                        new TankVelocityConstraint(100, DriveConstants.TRACK_WIDTH)
...
//
//        Trajectory scuipa2 = drive.trajectoryBuilder(new Pose2d(0, 0, Math.toRadians(0)))
//                .splineTo(new Vector2d(28, 0), Math.toRadians(-9),
//                        new MinVelocityConstraint(
//                                Arrays.asList(
//                                        new AngularVelocityConstraint(DriveConstants.MAX_ANG_VEL),
//                                        new TankVelocityConstraint(100, DriveConstants.TRACK_WIDTH)
...
//
//
//        Trajectory back2 = drive.trajectoryBuilder(new Pose2d(28, 7, Math.toRadians(0)))
//                .lineTo(new Vector2d(-16, 7),
//                        new MinVelocityConstraint(
//                                Arrays.asList(
//                                        new AngularVelocityConstraint(DriveConstants.MAX_ANG_VEL),
//                                        new TankVelocityConstraint(100, DriveConstants.TRACK_WIDTH)
...
//                .build();
//
//        Trajectory suge2 = drive.trajectoryBuilder(new Pose2d(-16, 10, Math.toRadians(90)))
//                .splineTo(new Vector2d(-22, 110), Math.toRadians(90),
//                        new MinVelocityConstraint(
//                                Arrays.asList(
//                                        new AngularVelocityConstraint(DriveConstants.MAX_ANG_VEL),
//                                        new TankVelocityConstraint(100, DriveConstants.TRACK_WIDTH)
...
//
//        Trajectory scuipa4 = drive.trajectoryBuilder(new Pose2d(0, 0, Math.toRadians(0)))
//                .splineTo(new Vector2d(15, 0), Math.toRadians(-14),
//                        new MinVelocityConstraint(
//                                Arrays.asList(
//                                        new AngularVelocityConstraint(DriveConstants.MAX_ANG_VEL),
//                                        new TankVelocityConstraint(100, DriveConstants.TRACK_WIDTH)
...
//
//
//        Trajectory back3 = drive.trajectoryBuilder(new Pose2d(15, 0, Math.toRadians(0)))
...
//                .build();
//
//        Trajectory suge3 = drive.trajectoryBuilder(new Pose2d(-24, 4, Math.toRadians(90)))
//                .splineTo(new Vector2d(-36, 125), Math.toRadians(90),
//                        new MinVelocityConstraint(
//                                Arrays.asList(
//                                        new AngularVelocityConstraint(DriveConstants.MAX_ANG_VEL),
//                                        new TankVelocityConstraint(100, DriveConstants.TRACK_WIDTH)
...
//        Trajectory merge = drive.trajectoryBuilder(new Pose2d(0, 0, 0))
//                .splineTo(new Vector2d(33, 0), Math.toRadians(-7),
//                        new MinVelocityConstraint(
//                                Arrays.asList(
//                                        new AngularVelocityConstraint(DriveConstants.MAX_ANG_VEL),
//                                        new TankVelocityConstraint(80, DriveConstants.TRACK_WIDTH)
...
//                .build();
//
//        Trajectory back = drive.trajectoryBuilder(new Pose2d(33, 0, Math.toRadians(0)))
//                .lineTo(new Vector2d(-8, 0),
//                        new MinVelocityConstraint(
//                                Arrays.asList(
//                                        new AngularVelocityConstraint(DriveConstants.MAX_ANG_VEL),
...
//
//        Trajectory suge2 = drive.trajectoryBuilder(new Pose2d(-16, 10, Math.toRadians(90)))
//                .splineTo(new Vector2d(-24, 110), Math.toRadians(90),
//                        new MinVelocityConstraint(
//                                Arrays.asList(
//                                        new AngularVelocityConstraint(DriveConstants.MAX_ANG_VEL),
//                                        new TankVelocityConstraint(80, DriveConstants.TRACK_WIDTH)
...
//
//        Trajectory scuipa4 = drive.trajectoryBuilder(new Pose2d(0, 0, Math.toRadians(0)))
//                .splineTo(new Vector2d(15, 0), Math.toRadians(-10),
//                        new MinVelocityConstraint(
//                                Arrays.asList(
//                                        new AngularVelocityConstraint(DriveConstants.MAX_ANG_VEL),
//                                        new TankVelocityConstraint(80, DriveConstants.TRACK_WIDTH)
...
//                .build();
//
//        Trajectory suge3 = drive.trajectoryBuilder(new Pose2d(-24, 0, Math.toRadians(90)))
//                .splineTo(new Vector2d(-30, 125), Math.toRadians(90),
//                        new MinVelocityConstraint(
//                                Arrays.asList(
//                                        new AngularVelocityConstraint(DriveConstants.MAX_ANG_VEL),
//                                        new TankVelocityConstraint(80, DriveConstants.TRACK_WIDTH)
...
//        static final Point REGION2_TOPLEFT_ANCHOR_POINT = new Point(330,440);
//        static final Point REGION3_TOPLEFT_ANCHOR_POINT = new Point(560,500);
//
//
//
//
