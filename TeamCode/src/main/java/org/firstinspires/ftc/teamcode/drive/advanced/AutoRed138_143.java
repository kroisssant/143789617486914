...
//
//@Autonomous
//public class AutoRed138_143 extends LinearOpMode {
//
//    //drivetrain
...
//                .lineToLinearHeading(new Pose2d(60,-15,Math.toRadians(-10)),
...
//
//
//        Trajectory dropSecondWobble = drive.trajectoryBuilder(new Pose2d(60,-15,0))
...
//                .strafeTo(new Vector2d(32.8,-22.3),
//                        new MinVelocityConstraint(
//                                Arrays.asList(
//                                        new AngularVelocityConstraint(DriveConstants.MAX_ANG_VEL),
//                                        new MecanumVelocityConstraint(100 ,DriveConstants.TRACK_WIDTH)
...
//                .build();
//
//        Trajectory prepareForRing1 = drive.trajectoryBuilder(new Pose2d(32.8,-22.3))
...
//                .build();
//
//        Trajectory getLastRing = drive.trajectoryBuilder(new Pose2d(40,-12))
...
//
//        drive.turn(Math.toRadians(10.7));
//        sleep(1000);
//        //1
//        manuta.setPosition(0.5);
//        sleep(100);
